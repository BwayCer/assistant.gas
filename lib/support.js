...
assistant.order( 'assistant/supportLite', function () {
    !function ( getSupportLite ) {
        getSupportLite()
             ...
             * @param {(Object|Array)} [target] - 目標物件。 預設為 `this`。
            ...
            .addProp( Object, 'assignEacyDeep',
                function assignEacyDeep( anyTarget, anySource, fnIsOwnProperty ) {
                    if ( arguments.length === 1
                        || ( arguments.length === 2 && typeof anySource === 'function' )
                    ) {
                        fnIsOwnProperty = anySource;
                        anySource = anyTarget;
                        anyTarget = this;
                        if ( anyTarget === Object ) throw Error( 'Illegal invocation.' );
                    }
    ...
    function () {
         ...
         * 檢查屬性。
         *
         * @memberof module:assistant.supportLite#
         * @func checkProp
         * @param {!*} main - 檢查之物件。
         ...
         * 參數見 {@link module:assistant.supportLite#addProp|supportLite#addProp} 。
         *
         * @memberof module:assistant.supportLite#
         * @func addProtoProp
         * @return {this}
         ...
         * 參數見 {@link module:assistant.supportLite#customProp|supportLite#customProp} 。
         *
         * @memberof module:assistant.supportLite#
