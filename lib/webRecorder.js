...
assistant.order( 'assistant/webRecorder', function ( self ) {
    ...
    function webRecorder( strService, strEnv, objRequest ) {
        ...
        this._dbSheet = dbSheet = gasdb( 'webRecorder', 'receiveRequest' );
        this._newRow  = newRow  = dbSheet.RowNew();
        this.dbKey    = dbKey   = dbSheet.readRange( [ dbSheet.RowLast(), 1 ] ) + 1;
        ...
        if ( !isGetType ) {
            ...
            newLine[ 10 ] = requestPostData.type;
            newLine[ 11 ] = contentLength;
            newLine[ 12 ] = requestPostData.contents;
        }
