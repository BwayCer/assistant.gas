...
assistant.order( 'assistant/tgbot', function ( self ) {
     ...
     * @throws {Error} Error(21, assistant_notExistTgbot)
    ...
    function tgbot(
        ...
        if ( botTokenList.hasOwnProperty( strBotName ) )
            ...
            throw Error( log.err( 21, 'assistant_notExistTgbot', strBotName ) );
        ...
        if ( bisShowReceiveContent && fhr.receive.contentLength > 0 ) {
            if ( /^[24]\d{2}$/.test( fhr.statusCode ) ) {
