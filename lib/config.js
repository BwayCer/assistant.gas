...
assistant.order( 'assistant/_config', function ( self ) {
        ...
        assign: function assignEacyDeep( anySource, anyTarget ) {
            ...
            for ( key in anySource ) {
                ...
                if ( key in anyTarget ) {
                    ...
                    if ( isDeepObject ) isDeepRead = valT_type === valS.constructor;
                }
    ...
    config.assign( {
        ...
        logMsgTable: {
            ...
            assistant_fetchHTTPStatusCode: 'Fetch %s HTTP status code.',
            assistant_notExistTgbot: 'The "%s" of Telegram Bot is not exist.',
        },
        spreadsheet: {
