import supportLite from './supportLite.mjs';
 ...
 *
 * @memberof! module:assistant.
 * @alias support.emptyEnum
 * @func  support.emptyEnum
 */
export function emptyEnum() {};
 ...
 *
 * @memberof! module:assistant.
 * @alias support.rewrapArr
 * @func  support.rewrapArr
 * @param {Array} source - 複製目標對象。
 * @return {Array}
 */
export function rewrapArr(source) {
 ...
 *
 * @memberof! module:assistant.
 * @alias support.spliceOne
 * @func  support.spliceOne
